<x-app-layout>
    ...
    <div class="lg:w-1/2 px-1 md:px-2 xl:px-8 pt-1 md:pt-2 xl:pt-8 pb-2 relative text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
        <form action="" method="POST">
            ...
            <div class="grid grid-cols-8 gap-1 sm:gap-4 items-start mb-2 xl:mb-4">
                <h6  
                ...
                <div class="grid grid-cols-3 col-span-6 rounded-md border border-blue-gray-200">
                    ...
                    <div class="inline-flex items-center">
                        ...
                        <label class="mt-px font-light text-gray-700 text-sm sm:text-base cursor-pointer select-none" for="{{ $role->role_name }}">
                            {{ $role->role_name }}
                        </label>
                    </div> 
                    @endforeach
