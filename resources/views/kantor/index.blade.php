		...
		<tbody>
			@foreach ($kantorRecords as $kantor)
				<tr class="even:bg-blue-gray-50/50 items-center">
					...
					<td class="py-2 lg:py-4">
                        <div class="flex gap-2 lg:p-4 items-center">
