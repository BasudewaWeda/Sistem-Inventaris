@php
  // Permissions
  $userManagement = App\Models\Role::checkPermission('user');
  $roleManagement = App\Models\Role::checkPermission('role');
  $inventaris = App\Models\Role::checkPermission('inventaris');
  $pemindahanInventaris = App\Models\Role::checkPermission('pemindahan-inventaris');
  $approvalInventaris = App\Models\Role::checkPermission('approval-inventaris');
  $approvalPemindahan = App\Models\Role::checkPermission('approval-pemindahan-inventaris');
  $kantorManagement = App\Models\Role::checkPermission('kantor');
