<x-app-layout>
    <div class="px-2 sm:px-8 pt-2 sm:pt-8 pb-2 text-3xl font-semibold text-blue-gray-900">
      	<h1>Inventaris</h1>
    </div>

    @if ($errors->any())
    <div role="alert"
      class="lg:w-2/3 relative flex p-4 mx-2 sm:mx-8 text-sm sm:text-base text-gray-900 border border-gray-900 rounded-lg font-regular"
      style="opacity: 1;">
    ...
    <div class="lg:w-2/3 px-2 sm:px-8 pt-2 sm:pt-8 pb-2 relative text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
        <form action="" method="POST">
            {{ csrf_field() }}
            <div class="grid grid-cols-8 gap-1 sm:gap-4 items-center mb-2 sm:mb-4">
                <label 
                for="judul" 
            ...
            <div class="flex gap-1 sm:gap-4 justify-end items-center">
                <div class="flex">
                    <a 
