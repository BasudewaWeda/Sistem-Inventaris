<x-app-layout>
    ...
    <div role="alert"
      ...
      <div class="m-1 xl:ml-3 mr-1 md:mr-4 xl:mr-12">
        <p class="block font-sans text-sm sm:text-sm antialiased font-medium leading-relaxed text-inherit">Errors occured:</p>
    ...
    <div class="2xl:w-1/2 px-1 md:px-2 xl:px-8 pt-1 md:pt-2 xl:pt-8 pb-2 relative text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
        <form action="" method="POST">
            {{ csrf_field() }}
            <div class="grid grid-cols-10 gap-1 sm:gap-4 items-center mb-2 xl:mb-4">
                <label 
                for="name" 
            ...
            <div class="grid grid-cols-10 gap-1 sm:gap-4 items-start mb-2 xl:mb-4">
                <h6  
                ...
                <div class="col-span-8">
                    ...
                    <div class="xl:grid xl:grid-cols-4 flex flex-wrap rounded-md border border-blue-gray-200 mb-2 xl:mb-4">
                        <h6  
                        class="mt-2 ml-2 col-span-4 block font-sans text-sm sm:text-base antialiased font-semibold leading-relaxed tracking-normal text-blue-gray-900">
                        ...
                        <div class="inline-flex items-center">
                            ...
                            <label class="mt-px font-light text-sm sm:text-base text-gray-700 cursor-pointer select-none" for="{{ $permission->permission_name }}">
                                {{ $permission->alias }}
                            </label>
                        </div> 
                        @endforeach
            ...
            <div class="flex gap-1 xl:gap-4 justify-end">
                <div class="flex">
                    <a 
