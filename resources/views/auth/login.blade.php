<x-guest-layout>
    ...
    <div class="relative flex flex-col text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
        ...
        <form class="max-w-screen-lg mt-4 mb-2 flex flex-col" method="POST" action="{{ route('login') }}">
            @csrf
                <h6
        ...
        <a href="/forget-password" class="block font-sans text-sm antialiased text-center leading-relaxed tracking-normal text-blue-gray-900 hover:underline hover:pointer">
            Forget password
        </a>
    </div>  
